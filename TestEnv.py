...
class Electric_Car(gym.Env):
    ...
    def reset(self):
        ...
        self.day = 1
        self.car_is_available = True
        self.battery_level = self.battery_capacity / 2  # Reset battery level to 50%
        
        # You may want to reset other environment variables if needed
    ...
    def observation(self):  # Returns the current state
        ...
        # if len(self.price_values[self.day])==1096:
        #     price = self.price_values[self.day - 2][self.hour - 1]

        # else:
            # if len(self.day - 1)==1096:
        # print(self.price_values.shape)
        ...
        # if len(self.old_states)>5:
        #     self.old_states.pop(0)
